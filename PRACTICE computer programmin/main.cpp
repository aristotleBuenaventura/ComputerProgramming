...
float bill(float& payment, float& change, float& vatAble, float& total, float& vat, int& newTransaction) { // This is where the user will enter the amount of money that they will pay.
		...
		do {
			...
			cin >> payment;
				...
				if (payment < total){
		    		...
		    		cin >> newTransaction;
		    		if (newTransaction == 1) { // resets all previous values for the new transactions
		    			main();
